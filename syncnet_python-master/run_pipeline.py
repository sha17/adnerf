...
parser.add_argument('--videofile',      type=str, default='data/Obama_ver2.mp4',   help='Input video file');
    ...
    for framefaces in scenefaces:
      for face in framefaces:
        if track == []:
          ...
          break
    # track num : 8000 ('frame':framenum, 'bbox':[list num 4])
    # tracks num : 8000
...
def crop_video(opt,track,cropfile):
  ...
  audiostart  = (track['frame'][0])/opt.frame_rate #0 (sec)
  audioend    = (track['frame'][-1]+1)/opt.frame_rate  #320 (sec)
  ...
  #'ffmpeg -y -i data/work/pycrop/00000t.avi -i data/work/pytmp/audio.wav -c:v copy -c:a copy data/work/pycrop/00000.avi'
